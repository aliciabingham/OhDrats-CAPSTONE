...
namespace OhDrats.DependencyResolution {
    using Controllers;
    ...
    public class DefaultRegistry : Registry {
        ...
        public DefaultRegistry() {
            ...
            For<IDbConnection>().Use(c => new SqlConnection(ConfigurationManager.ConnectionStrings["OhDrats"].ConnectionString));

            For<IOpponentRepository>().Use<OpponentRepository>();
